			...
			<div id="container">
				<Row className = "Row">
                    ...
                    <Col xs={9}>
						<Row>
							<Col xs={3}>
								<Form.Select className="me-sm-2" id="inlineFormCustomSelect" placeholder="Provinsi" value={this.state.selectedProvinsi} onChange={this.changeProvinsi}>
							...
							<Col xs={3}>
								<Form.Select className="me-sm-2" id="inlineFormCustomSelect" placeholder="Kabupaten" value={this.state.selectedKabupaten} onChange={this.changeKabupaten}>
							...
							<Col xs={3}>
								<Form.Select className="me-sm-2" id="inlineFormCustomSelect" placeholder="Kecamatan">
